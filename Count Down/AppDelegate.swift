...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        // UPDATE: Only do this if something changed
        // Delete all data
        for _ in 0...eventsArray.count - 1 + deleted {
            CoreDataManager.deleteEvent(entity: "StorageEntity")
        }
        // replace new data
        if eventsArray.count > 0 {
            for i in 0...eventsArray.count - 1 {
                CoreDataManager.storeObject(event: eventsArray[i])
            }
        }
    }
    ...
    func applicationWillTerminate(_ application: UIApplication) {
        ...
        // Delete all data
        for _ in 0...eventsArray.count - 1 {
            CoreDataManager.deleteEvent(entity: "StorageEntity")
        }
        // replace all data
        for i in 0...eventsArray.count - 1 {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Count_Down")
